<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"G:\php\wamp64\www\tp\public/../application/index\view\user\my_resume.html";i:1505078515;s:71:"G:\php\wamp64\www\tp\public/../application/index\view\index\header.html";i:1505059853;s:71:"G:\php\wamp64\www\tp\public/../application/index\view\index\footer.html";i:1504882203;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<div id="offCanvasContentScroll" class="mui-content mui-scroll-wrapper">
			<div class="mui-scroll">
				...
				<div class="mui-card">
					<div class="mui-card-content">
						<div class="mui-card-content-inner">
							...
							软件掌握：office:<?php echo (isset($user_resume['Office']) && ($user_resume['Office'] !== '')?$user_resume['Office']:'不熟练'); ?>%、ps:<?php echo (isset($user_resume['Ps']) && ($user_resume['Ps'] !== '')?$user_resume['Ps']:''); ?>%<hr>
				...
				<div class="resume_operation">
					...
					<a href="http://localhost/tp/extend/pdf/examples/pdf.php?schoolid=<?php echo $user_info['schoolid']; ?>" class="mui-btn mui-btn-primary " style="padding: 5px 20px;">下载简历表</a>
